...
<!-- Mirrored from themes.hody.co/html/bezel/portfolio-grid-4col.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Jul 2022 14:52:52 GMT -->
<head>
    <title>Products | Meera Dyestuff</title>
    <meta charset="UTF-8">
        ...
        <div class="row-parallax-bg">
          <div class="parallax-wrapper">
            <div class="parallax-bg">
              <img src="images/bg-image-19.jpg" alt="">
            </div>
          </div>
        ...
        <div class="container">
          <div class="row">
            <ul id="filters">
              ...
              <li data-filter=".branding">Meerafix F Dyes</li>
              <li data-filter=".product-design">Meerafix XD Dyes</li>
              <li data-filter=".packaging">Meerazol VS Dyes</li>
              <li data-filter=".ui-ux">Meerocion P Dyes</li>
              <li data-filter=".packaging1">Meerocion HE Dyes</li>
              <li data-filter=".ui-ux1">Mirius ACID/DIRECT Dyes</li>
            </ul>
